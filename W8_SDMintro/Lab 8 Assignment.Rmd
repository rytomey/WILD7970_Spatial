...
$\color{red}{\text{Good. Another major difference is that bioclim is not relying on pseudo-absence data. +3.5}}$
...
$\color{red}{\text{Importantly, the scale on the presence-background map is completely controlled by how many random background points you select, so that accounts for the larger predicted values for the presence-absence model. +3.5}}$
