...
$\color{red}{\text{As theta increases, we're actually starting to see convergence on the single, best least cost path. In other words, as theta increases, there is less freedom to deviate from the shortest/least cost path. +4}}$
...
$\color{red}{\text{Hm, it seems you got all of the numbers right, but I'm reading this differently than you. Both IIC and PC are lower when you remove patch 7 than when you remove patch 6, so removal of patch 7 has the most negative effect on connectivity. +4 }}$